...
def test_exterior_facet_functional_assembly():
    x = np.array([[0.0, 0.0], [1 / 3, 0.0], [2 / 3, 0.0], [1.0, 0.0],
    ...
    #               ],
    #              dtype=np.float64)
    cells = np.array([[0, 1, 5], [0, 5, 4], [1, 2, 6], [1, 6, 5], [2, 3, 7],
                      [2, 7, 6], [4, 5, 9], [4, 9, 8], [5, 6, 10], [5, 10, 9],
                      [6, 7, 11], [6, 11, 10], [8, 9, 13], [8, 13, 12],
                      [9, 10, 14], [9, 14, 13], [10, 11, 15], [10, 15, 14]],
                     dtype=np.int32)
